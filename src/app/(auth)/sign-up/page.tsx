      ...
      >
        ...
        <motion.div className="text-center" variants={itemVariants}>
          <h1 className="text-3xl leading-[160%] font-semibold text-gray-900">
            Create your Dentispark account
          </h1>
          <p className="font-sora mt-2 text-sm text-gray-600">
            By continuing below, you agree to our{" "}
        ...
        <motion.div className="space-y-4" variants={itemVariants}>
          <Button
            ...
            disabled={oauth2SignupMutation.isPending}
          >
            {oauth2SignupMutation.isPending ? (
              <>
                <div className="mr-3 h-6 w-6 animate-spin rounded-full border-2 border-gray-300 border-t-blue-600"></div>
